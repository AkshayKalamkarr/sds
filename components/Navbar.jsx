...
function Navbar({ className }) {
    ...
    // Define these BEFORE any effect references them
    ...
    // Lock body scroll when mobile menu is open, and reset open dropdowns
    // whenever the menu closes (hamburger, overlay, Escape, drawer X, route change)
    useEffect(() => {
    ...
    return (
        <>
                    ...
                    <Menu setActive={setActive}>
                        ...
                        <MenuItem setActive={setActive} active={active} item="About">
                            <div className="flex flex-col space-y-4 text-sm">
                                <HoveredLink href="/about/supremeInfrastructure">SDS BHARAT INFRATECH</HoveredLink>
            ...
            >
                ...
                {/* Drawer Nav Items */}
                <nav className="font-nav tracking-wide mt-4 flex flex-col px-6 pb-8 overflow-y-auto max-h-[calc(100vh-80px)]">
...
const MobileMenuItem = React.memo(({ href, onClick, children }) => (
    <Link
        href={href}
        onClick={onClick}
        className="block py-3 text-base font-semibold text-gray-800 dark:text-gray-100 hover:text-amber-500 dark:hover:text-amber-400 border-b border-gray-50 dark:border-gray-800 transition-colors duration-200"
    >
        {children}
    </Link>
));
...
const MobileMenuDropdown = React.memo(({ title, isOpen, onClick, children }) => (
    <div className="border-b border-gray-50 dark:border-gray-800">
        <button
            ...
            className="flex items-center justify-between w-full py-3 text-base font-semibold text-gray-800 dark:text-gray-100 hover:text-amber-500 dark:hover:text-amber-400 transition-colors duration-200 focus:outline-none"
        >
            {title}
            <ChevronDown
                className={cn(
