...
const ProjectCard = React.memo(({ project }) => (
  <Link href={`/project/horticultureprojects/${project.slug}`} className="block">
    <motion.div
      initial="hidden"
      whileInView="visible"
...
const HeroSection = React.memo(() => (
  <div className="relative w-full">
    <div className="absolute inset-0">
      <Image
        src="/images/projects/horticulturebackgrounds.jpg"
...
export default HorticultureProject;